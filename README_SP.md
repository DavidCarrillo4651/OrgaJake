...
* El código de cada consigna está escrito en el archivo _app.s_
* El archivo _start.s_ contiene la inicialización del FrameBuffer, al finalizar llama a _app.s_
* El código implementado pinta en pantalla una imagen compuesta de poligonos simples
...
## Requisitos
En sistemas Ubuntu/Debian se pueden  instalar con:
...
2. QEMU ARM
    ...
    ```
3. Instalar AARCH GDB
    ```bash
    $ sudo apt install gdb-multiarch
    ```
4. *OPCIONAL* Configurar GDB para hacer las cosas más "amigables"
    ```bash
